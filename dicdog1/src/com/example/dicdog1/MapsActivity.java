...
public class MapsActivity extends FragmentActivity implements OnMarkerClickListener {
					 ...
					 appLocationService = new AppLocationService(MapsActivity.this);      
				      ...
				      try {
				         ...
				         if (gpsLocation != null) 
							...
							{
							//Toast.makeText(getApplicationContext(), "Showing All the Hospitals with the Speciality", Toast.LENGTH_LONG).show();							
							Toast.makeText(getApplicationContext(),"Displaying Required Hospitals\nClick on Marker for Doctors List",Toast.LENGTH_LONG).show();
							
					 		//Toast.makeText(getApplicationContext(),"Click on the Marker for doctors list",Toast.LENGTH_LONG).show();					 		        				     
   ...
   public void showSettingsAlert(String provider) {
 		...
 		alertDialog.setNegativeButton("Cancel",new DialogInterface.OnClickListener() {
 			public void onClick(DialogInterface dialog, int which) {
 				dialog.cancel();
 				Intent intent = new Intent(MapsActivity.this, SearchMaps.class);
 				MapsActivity.this.startActivity(intent);
 				finish();
 			}});
 		alertDialog.show();
